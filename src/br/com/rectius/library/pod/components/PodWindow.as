...
package br.com.rectius.library.pod.components
{
	import br.com.rectius.library.pod.events.PodWindowEvent;
	 ...
	 */
	[Event(name="minimize", type="br.com.rectius.library.pod.events.PodWindowEvent")]
	 ...
	 *  @productversion Flex 4
	 */
	[Event(name="maximize", type="br.com.rectius.library.pod.events.PodWindowEvent")]
	 ...
	 *  @productversion Flex 4
	 */
	[Event(name="normal", type="br.com.rectius.library.pod.events.PodWindowEvent")]
	 ...
	 *  @productversion Flex 4
	 */
	[Event(name="change", type="br.com.rectius.library.pod.events.PodWindowEvent")]
	...
	public class PodWindow extends SkinnableContainer
	{
		...
		{
			var dragInitiator:PodWindow = PodWindow(this);
